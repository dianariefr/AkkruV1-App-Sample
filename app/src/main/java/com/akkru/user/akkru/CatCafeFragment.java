 ...
 * {@link CatCafeFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link CatCafeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CatCafeFragment extends Fragment {
    ...
    //Inisialisasi
    private CatCafeAdapter mAdapter;
     ...
     * @return A new instance of fragment CatCafeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CatCafeFragment newInstance(String param1, String param2) {
        CatCafeFragment fragment = new CatCafeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cat_cafe, container, false);
        //Binding
        swipeCatCafe = rootView.findViewById(R.id.Swipe_CatCafe);
        recyclerCatCafe = rootView.findViewById(R.id.Recycler_CatCafe);
        ...
        mAdapter = new CatCafeAdapter(cafeList, recyclerCatCafe);
    ...
    private void loadData() {
        for (int i = 1; i <= 20; i++) {
            cafeList.add(new CategoryModel(R.drawable.dummybar, "Aufa Cafe", "Condong Catur, Yogyakarta", "Open Now"));
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for (int i = start + 1; i <= end; i++) {
                            cafeList.add(new CategoryModel(R.drawable.dummybar, "Fatih Cafe", "Mlati, Yogyakarta", "Closed Now"));
